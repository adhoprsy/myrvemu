...
// same calculation, but different types
...
static void func_slli(state_t *state, insn_t *insn) { FUNC(rs1 << (imm & 0x3f)); }
static void func_slti(state_t *state, insn_t *insn) { FUNC((i64)rs1 << (i64)imm); }
static void func_sltiu(state_t *state, insn_t *insn) { FUNC((u64)rs1 << (u64)imm); }
static void func_xori(state_t *state, insn_t *insn) { FUNC(rs1 ^ imm); }
static void func_srli(state_t *state, insn_t *insn) { FUNC(rs1 >> (imm & 0x3f)); }
static void func_srai(state_t *state, insn_t *insn) { FUNC((i64)rs1 >> (imm & 0x3f)); }
...
static void func_addiw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 + imm)); }
static void func_slliw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 << (imm & 0x1f))); }
static void func_srliw(state_t *state, insn_t *insn) { FUNC((i64)(i32)((u32)rs1 >> (imm & 0x1f))); }
static void func_sraiw(state_t *state, insn_t *insn) { FUNC((i64)((i32)rs1 >> (imm & 0x1f))); }
#undef FUNC
...
static void func_sll(state_t *state, insn_t *insn) { FUNC(rs1 << (rs2 & 0x3f)); }
static void func_slt(state_t *state, insn_t *insn) { FUNC((i64)rs1 < (i64)rs2); }
static void func_sltu(state_t *state, insn_t *insn) { FUNC((u64)rs1 < (u64)rs2); }
static void func_xor(state_t *state, insn_t *insn) { FUNC(rs1 ^ rs2); }
static void func_srl(state_t *state, insn_t *insn) { FUNC(rs1 >> (rs2 & 0x3f)); }
...
static void func_mulhsu(state_t *state, insn_t *insn) { FUNC(mulhsu(rs1, rs2)); }
...
static void func_div(state_t *state, insn_t *insn) { 
  ...
  else if (rs1 == INT64_MIN && rs2 == UINT64_MAX) rd = INT64_MIN;
  else rd = (i64)rs1 / (i64)rs2;
...
static void func_rem(state_t *state, insn_t *insn) { 
  ...
  u64 rd = 0;
  if (rs2 == 0) rd = rs1;
  else if (rs1 == INT64_MIN && rs2 == UINT64_MAX) rd = 0;
  else rd = (i64)rs1 % (i64)rs2;
  state->gp_regs[insn->rd] = rd; 
}
static void func_sub(state_t *state, insn_t *insn) { FUNC(rs1 - rs2); }
static void func_sra(state_t *state, insn_t *insn) { FUNC((i64)rs1 >> (rs2 & 0x3f)); }
static void func_lui(state_t *state, insn_t *insn) { 
  state->gp_regs[insn->rd] = (i64)insn->imm;
}
static void func_remu(state_t *state, insn_t *insn) { FUNC(rs2 == 0 ? rs1 : rs1 % rs2); }
static void func_addw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 + rs2)); }
static void func_sllw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 << (rs2 & 0x1f))); }
static void func_srlw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 >> (rs2 & 0x1f)));  }
static void func_mulw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 * rs2)); }
...
static void func_subw(state_t *state, insn_t *insn) { FUNC((i64)(i32)(rs1 - rs2)); }
static void func_sraw(state_t *state, insn_t *insn) { FUNC((i64)(i32)((i32)rs1 >> (rs2 & 0x3f))); }
#undef FUNC
...
static void func_beq(state_t *state, insn_t *insn) { FUNC((u64)rs1 == (u64)rs2); }
static void func_bne(state_t *state, insn_t *insn) { FUNC((u64)rs1 != (u64)rs2); }
static void func_blt(state_t *state, insn_t *insn) { FUNC((u64)rs1 < (u64)rs2); }
static void func_bge(state_t *state, insn_t *insn) { FUNC((u64)rs1 > (u64)rs2); }
static void func_bltu(state_t *state, insn_t *insn) { FUNC((u64)rs1 <= (u64)rs2); }
static void func_bgeu(state_t *state, insn_t *insn) { FUNC((u64)rs1 >= (u64)rs2); }
#undef FUNC
...
static void func_fmadd_s(state_t *state, insn_t *insn) { FUNC(rs1 * rs2 + rs3); }
static void func_fmsub_s(state_t *state, insn_t *insn) { FUNC(rs1 * rs2 - rs3); }
static void func_fnmsub_s(state_t *state, insn_t *insn) { FUNC(-(rs1 * rs2) + rs3); }
static void func_fnmadd_s(state_t *state, insn_t *insn) { FUNC(-(rs1 * rs2) - rs3); }
#undef FUNC
...
#define FUNC(expr) \
  ...
  state->fp_regs[insn->rd].d = (f32)expr; \

static void func_fmadd_d(state_t *state, insn_t *insn) { FUNC(rs1 * rs2 + rs3); }
static void func_fmsub_d(state_t *state, insn_t *insn) { FUNC(rs1 * rs2 - rs3); }
static void func_fnmsub_d(state_t *state, insn_t *insn) { FUNC(-(rs1 * rs2) + rs3); }
static void func_fnmadd_d(state_t *state, insn_t *insn) { FUNC(-(rs1 * rs2) - rs3); }
#undef FUNC
...
static void func_fsqrt_s(state_t *state, insn_t *insn) { FUNC(sqrt(rs1)); }
static void func_fmin_s(state_t *state, insn_t *insn) { FUNC(rs1 < rs2 ? rs1 : rs2); }
static void func_fmax_s(state_t *state, insn_t *insn) { FUNC(rs1 > rs2 ? rs1 : rs2); }
#undef FUNC
...
static void func_fmin_d(state_t *state, insn_t *insn) { FUNC(rs1 < rs2 ? rs1 : rs2); }
static void func_fmax_d(state_t *state, insn_t *insn) { FUNC(rs1 > rs2 ? rs1 : rs2); }
#undef FUNC
