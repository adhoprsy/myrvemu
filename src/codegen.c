/**
 * translate rv bitcode to C, and optimize with clang
*/
...
// record all the regs used in this block, get them to a variable, 
// variables are on stack, no need to access mem of gp_reg  
